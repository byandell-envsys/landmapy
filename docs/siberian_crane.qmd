...
```{python}
#| label: fig-occurrences-by-decade
...
```{python}
#| label: fig-occurrence-map-decades
...
occurrence_hvplot = hvplot_occurrence(occurrence_gdf, 'decade', title="Grus leucogeranus Siberian Crane Decadal Tracking")
# Save the plot
