...
delta_hv = hvplot_delta_gdf(delta_gdf)
import holoviews as hv
hv.save(delta_hv, 'delta_map.html')
```

<iframe src="delta_map.html" width="100%" height="350px" style="border: none;"></iframe>
...
cache_path = os.path.join(et.io.HOME, et.io.DATA_NAME, "jars", "delta_reflectance_da_df.pickle")
...
## Alternative HV Dynamic Plot

```{python}
#| eval: true
import hvplot.xarray
from landmapyr.hv_plots import hvplot_cluster
cluster_hv = hvplot_cluster(rgb_sat, model_df)
import holoviews as hv
hv.save(cluster_hv, 'cluster_map.html')
```
